...
export default function Home() {
  ...
  const [elColor1, setElcolor1] = useState(null);
  const [elColor2, setElcolor2] = useState(null);
  ...
  const dataSava = () => {
    ...
    olorList = JSON.stringify(colorList)
    localStorage.setItem(count, colorList)
  ...
  return (
    <>
      ...
      <Header />
      <h1 className={styles.}>Nike ID</h1>
      <div>
        ...
        >
          <path
            onClick={() => activeClass("logo")}
            className={activeEl === 'logo' ? styles.active : ""}
            id="logo"
            style={{fill: elColor1}}
      ...
      <div  className={styles.ui_wrapper}>
        <p>
          <input onChange type="color" className={styles.colorSelector}/>
        </p>
